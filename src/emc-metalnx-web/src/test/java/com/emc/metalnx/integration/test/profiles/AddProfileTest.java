...
public class AddProfileTest {
    ...
    /**
     * Test method for adding a user profile with valid name, description and groups names. It
     * verifies if success message is displayed and profile appears in list after submit form.
     */
    @Test
    ...
    /**
     * Test method for adding a user profile with a empty name. It verifies
     * if it remains in same page and does not add new profile.
     */
    @Test
    ...
    /**
     * Test method for adding a user profile with an existent name. It verifies
     * if it remains in same page and does not add new profile.
     */
    @Test
