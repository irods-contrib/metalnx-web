...
public class SearchResourceTest {
    ...
    public void setUp() throws Exception {
        ...
        ResourceUtils.addResource(UITest.RESOURCES_URL, RESC_NAME_1, ResourceUtils.RESC_COMPOUND, null, null, null, null, driver);
        ResourceUtils.addResource(UITest.RESOURCES_URL, RESC_NAME_2, ResourceUtils.RESC_COMPOUND, null, null, null, null, driver);
        ResourceUtils.addResource(UITest.RESOURCES_URL, RESC_NAME_3, ResourceUtils.RESC_COMPOUND, null, null, null, null, driver);
        ResourceUtils.addResource(UITest.RESOURCES_URL, RESC_NAME_4, ResourceUtils.RESC_COMPOUND, null, null, null, null, driver);
    }
    ...
    /**
     * Test method to make a search by empty content in search box. It verifies if same resources before
     * search are displayed after type ENTER in search box.
     */
    @Test
    ...
    /**
     * Test method to execute a search by one letter in upper case in search box. It verifies if no
     * filtering is dispatched once that it will only be triggered by typing more than one letter.
     */
    @Test
    ...
    /**
     * Test method to execute a search by one letter in lower case in search box. It verifies if no
     * filtering is dispatched once that it will only be triggered by typing more than one letter.
     */
    @Test
    ...
    /**
     * Test method to execute a search by more than one letter in upper case in search box. It verifies
     * if search is case insensitive and filters resources correctly.
     */
    @Test
    ...
    /**
     * Test method to execute a search by more than one letter in lower case in search box. It verifies
     * if search is case insensitive and filters resources correctly.
     */
    @Test
    ...
    /**
     * Test method to execute a search by more than one letter. It verifies if only one resource will
     * be show after search.
     */
    @Test
    ...
    /**
     * Test method to execute a search by more than one letter. It verifies if no resources will
     * be show after search.
     */
    @Test
