...
public class FilePermissionTest {
    ...
    /**
     * Test method to check if it is possible to access a file in public folder that does not belong
     * to the current user without crashing the application.
     * The ideal scenario would be to display a message informing that the user does not have
     * permission access to that file
     */
    @Test
    public void testOpenFileFromAnotherUser() {
        ...
        // Code below logs in as rodsuser to try and access a file that does not belong to him
    ...
    public void testGiveReadPermissions() {
        ...
        file.click();
        // once in the file location, we use the method below to add a permission through
        // permission tab
    ...
    /**
     * This method below is used so that once the driver is in the file's location, we navigate
     * through the tabs to add a permission to the current file
     */
    private void addPermissionToCollection(WebDriver driver, String uname, String permission) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".nav.nav-tabs a[href=\"#userPermissions\"]")));
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#addPermissionButtonDiv a[data-target=\"#newUserPermissionModal\"]")));
        driver.findElement(By.cssSelector("#addPermissionButtonDiv a[data-target=\"#newUserPermissionModal\"]")).click();
