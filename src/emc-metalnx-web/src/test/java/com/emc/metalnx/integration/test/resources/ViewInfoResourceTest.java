...
public class ViewInfoResourceTest {
	...
	public void setUp() throws Exception {
		...
		ResourceUtils.addResource(UITest.RESOURCES_MAP_URL, RESOURCE_COORDINATING_NAME, RESOURCE_COORDINATING_TYPE,
				RESOURCE_PARENT, RESOURCE_ZONE, RESOURCE_HOST, RESOURCE_PATH, driver);
		ResourceUtils.addResource(UITest.RESOURCES_MAP_URL, RESOURCE_STORAGE_NAME, RESOURCE_STORAGE_TYPE,
				RESOURCE_PARENT, RESOURCE_ZONE, RESOURCE_HOST, RESOURCE_PATH, driver);
	}
