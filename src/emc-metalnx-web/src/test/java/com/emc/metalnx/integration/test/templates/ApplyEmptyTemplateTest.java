...
public class ApplyEmptyTemplateTest {
    ...
    /**
     * Method that tests if Metalnx prevents an empty template from being applied to files.
     *
    ...
    public void testApplyTemplateWithNoMetadataFieldsOnFile() throws DataGridException {
        ...
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(TemplateUtils.SUBMIT_TEMPLATE_BTN));
    ...
    /**
     * Method that tests if Metalnx prevents an empty template from being applied to collections.
     */
    @Test
