...
public class UploadTests {
    ...
    public void test1() throws FailingHttpStatusCodeException, MalformedURLException, IOException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(fileInput)).sendKeys(
                "C:\\Users\\ipenoguh.TPA-ELD\\Documents\\docs\\apostila_conteudo_cursojulho2013.pdf");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#treeViewTable_filter input"))).sendKeys(
                "apostila_conteudo_cursojulho2013.pdf");
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#treeViewTable tbody tr td")));
    }
