...
public class CancelApplyTemplateOnFilesTest {
    ...
    /**
     * Test that checks if the cancel button in the step 1 (Template selection) works. No metadata
     * should be added.
     */
    @Test
    ...
    /**
     * Test that checks if the cancel button in the step 2 (Templates' fields list) works. No
