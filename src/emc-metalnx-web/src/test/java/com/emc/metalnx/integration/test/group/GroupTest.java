...
public class GroupTest {
    ...
    /**
     * Test method for adding a brand new group to the system. It verifies if
     * after adding group, the group is redirected to the group management page;
     * if this group now exists in the groups list; and if the number of groups
     * existing was incremented by one.
     */
    @Test
    ...
    /**
     * Test method that checks when adding a user with an empty groupname
     * if the UI gets this exception and shows an error message.
     */
    @Test
    ...
    /**
     * Test method that removes the group created by other test methods. It leaves the Group
     * Management as it was before the test session started.
     */
    @Test
