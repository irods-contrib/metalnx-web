...
public interface SpecificQueryProvider {
	 ...
	 *
	 * @param parentPath <code>String</code> path to the parent collection where you
	 *                   are looking for items that match a search term
	 * @param searchText <code>String</code> term to be matched
	 ...
	 * @param parentPath <code>String</code> path to the parent collection where you
	 *                   are looking for items that match a search term
	 * @param searchText <code>String</code> with term to be matched
	 * @param offset     <code>int</code> with partial start index
	 * @param limit      <code>int</code> max number of items retrieved
	 * @return <code>String</code> with the SQL text
	 **/
	 ...
	 *
	 * @param metadataSearch     <code>List</code> of {@link DataGridMetadataSearch}
	 *                           with the user supplied search terms search criteria
	 * @param zone               <code>String</code> zone to be looking for data
	 *                           objects or collections
	 * @param searchAgainstColls <code>boolean</code> Flag set to <code>true</code>
	 *                           when looking for collections. <code>false</code>
	 *                           when looking for data objects.
	 * @param offset             {@code int} with an offset, 0 if not used
	 * @param limit              {@code limit} of rows returned, 0 if not used
	 * @return <code>String</code> with the SQL text
	 */
	 ...
	 * database flavor
	 * 
	 * @param attribute {@link FilePropertyField} specifying the data grid property
	 *                  search
	 * @param operator  {@link DataGridSearchOperatorEnum} with the operator for the
	 *                  query
	 * @param value     <code>String</code> with the value for the search
	 * @return <code>String</code> with the SQL text
	 */
	 ...
	 * 
	 * @param query  <code>String</code> with the database query
	 * @param offset <code>int</code> with the offset
	 * @param limit  <code>int</code> with the limit
	 ...
	 * search
	 * 
	 * @param filePropertiesSearch <code>List</code> of
	 *                             {@link DataGridFilePropertySearch} that
	 *                             constitute the query
	 * @param zone                 <code>String</code> zone to be looking for data
	 *                             objects or collections
	 * @param searchAgainstColls   <code>boolean</code> Flag set to
	 *                             <code>true</code> when looking for collections.
	 *                             <code>false</code> when looking for data objects.
	 * @return <code>String</code> with the appropriate sql query
	 */
	 ...
	 *                             <code>true</code> when looking for collections.
	 *                             <code>false</code> when looking for data objects.
	 * @param offset               <code>int</code> with query offset
	 * @param limit                <code>int</code> with query results limit
	 * @return <code>String</code> with the appropriate sql query
	 */
