...
public class GroupBookmarkController {
	...
	public String listGroupsByQuery(final Model model) throws DataGridConnectionRefusedException {
		String currentUser = "";
		String currentZone = "";
	...
	@ResponseBody
	public String addBookmarkToGroup(@RequestParam("groupName") final String groupName,
	...
	@ResponseBody
	public String removeBookmarkFromGroup(@RequestParam("groupName") final String groupName,
			@RequestParam("path") final String path) {
	...
	@ResponseBody
	public String listGroupsByQueryPaginatedModel(final HttpServletRequest request)
		...
		try {
			groupBookmarks = groupBookmarkService.getGroupsBookmarksPaginated(currentUser, currentZone, start, length,
	 ...
	 */
	public boolean addPathAsGroupBookmark(final String path) {
