...
public class DataGridFilePropertySearch {
	...
	// TODO:add icat type enum and call to factory
	...
	// TODO: add icat type enum and call to factory
	// TODO: add call with instance vars as params
	public String getWhereClause() {
		...
		boolean isAttributeEqualsDate = this.attribute == FilePropertyField.CREATION_DATE
				|| this.attribute == FilePropertyField.MODIFICATION_DATE;
		...
		} else if (isAttributeEqualsDate || this.attribute == FilePropertyField.REPLICA_NUMBER
				|| this.attribute == FilePropertyField.SIZE) {
